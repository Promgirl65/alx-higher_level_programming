...
Module contains the function that multiplies 2 Matrices.
...
def matrix_mul(m_a, m_b):
    ...
    Args:
        m_a (list of lists of int/float): Matrix (a) to be multiplied.
        m_b (list of lists of int/float): Matrix (b) to be multiplied.
